...
class MethodTest extends Test {
    ...
    def test_inspect {
        assert_equal("#<BoundMethod: MethodTest#test_inspect(0) bound to #{self}>", self:test_inspect.inspect);
    }

    def test_unbound_inspect {
        assert_equal("#<Method: MethodTest#test_inspect(0)>", self:test_inspect.unbind.inspect);
    }
